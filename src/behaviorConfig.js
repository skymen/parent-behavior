      ...
      params: [
        {
          id: "layer",
          name: "Layer",
          desc: "The layer to parent to",
          type: "layer",
          value: "",
        },
        {
          id: "sublayers",
          name: "Parent Sublayers",
          desc: "Whether to parent sublayers",
          type: "boolean",
          value: false,
        },
        // parent options are x, y, width, height, angle, opacity, z elevation, visibility, and destroy with parent, all booleans
        {
          id: "x",
          name: "X",
          desc: "Whether to parent X",
          type: "boolean",
          value: true,
        },
        {
        ...
        },
        {
          id: "opacity",
          name: "Opacity",
          desc: "Whether to parent Opacity",
          type: "boolean",
          value: false,
        },
        {
          id: "z",
          name: "Z Elevation",
          desc: "Whether to parent Z Elevation",
          type: "boolean",
          value: true,
        },
        {
          id: "visibility",
          name: "Visibility",
          desc: "Whether to parent Visibility",
          type: "boolean",
          value: false,
        },
        {
          ...
          desc: "Whether to destroy with parent",
          type: "boolean",
          value: false,
        },
      ],
      listName: "Parent Layer",
      displayText:
        "{my}: Parent to layer [b]{0}[/b] (sublayers: [i]{1}[/i], X: [i]{2}[/i], Y: [i]{3}[/i], Width: [i]{4}[/i], Height: [i]{5}[/i], Angle: [i]{6}[/i], Opacity: [i]{7}[/i], Z Elevation: [i]{8}[/i], Visibility: [i]{9}[/i], Destroy with Parent: [i]{10}[/i])",
      description: "Parent to a layer",
    },
    RemoveAllChildren: {
      category: "general",
      forward: "_RemoveAllChildren",
      autoScriptInterface: true,
      highlight: true,
      deprecated: false,
      params: [],
      listName: "Remove All Children",
      displayText: "{my}: Remove all children",
      description: "Remove all children",
    },
    RemoveChildrenFromLayer: {
      category: "general",
      forward: "_RemoveChildrenFromLayer",
      autoScriptInterface: true,
      highlight: true,
      deprecated: false,
      params: [
        {
          id: "layer",
          name: "Layer",
          desc: "The layer to remove children from",
          type: "layer",
          value: "",
        },
        {
          id: "sublayers",
          name: "Remove Sublayers",
          desc: "Whether to remove sublayers",
          type: "boolean",
          value: false,
        },
      ],
      listName: "Remove Children From Layer",
      displayText:
        "{my}: Remove children from layer [b]{0}[/b] (sublayers: [i]{1}[/i])",
      description: "Remove children from a layer",
    },
  },
  Cnds: {
    /*
